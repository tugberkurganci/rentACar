...
public interface CarRepository extends JpaRepository<Car,Integer> {
    ...
    @Query("SELECT new com.tobeto.pair3.services.dtos.responses.GetCarResponse(c.id, c.kilometer, c.plate, c.year, c.dailyPrice, c.model.name,c.color.name,c.image) " +
            "FROM Car c WHERE "+
